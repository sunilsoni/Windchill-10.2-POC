...
public class IESoapServletLocator extends org.apache.axis.client.Service implements com.ptc.www.infoengine.soap.rpc.message.IESoapServlet {
    ...
    public com.ptc.www.infoengine.soap.rpc.message.IEService getIESoapPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.ptc.www.infoengine.soap.rpc.message.IEService getIESoapPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ptc.www.infoengine.soap.rpc.message.SoapBindingStub _stub = new com.ptc.www.infoengine.soap.rpc.message.SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ptc.www.infoengine.soap.rpc.message.IEService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ptc.www.infoengine.soap.rpc.message.SoapBindingStub _stub = new com.ptc.www.infoengine.soap.rpc.message.SoapBindingStub(new java.net.URL(IESoapPort_address), this);
                _stub.setPortName(getIESoapPortWSDDServiceName());
                return _stub;
            }
        }
