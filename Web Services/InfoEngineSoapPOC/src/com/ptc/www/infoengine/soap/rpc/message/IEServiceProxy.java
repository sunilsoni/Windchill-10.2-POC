...
public class IEServiceProxy implements com.ptc.www.infoengine.soap.rpc.message.IEService {
  private String _endpoint = null;
  private com.ptc.www.infoengine.soap.rpc.message.IEService iEService = null;
  ...
  private void _initIEServiceProxy() {
    try {
      iEService = (new com.ptc.www.infoengine.soap.rpc.message.IESoapServletLocator()).getIESoapPort();
      if (iEService != null) {
        if (_endpoint != null)
  ...
  public com.ptc.www.infoengine.soap.rpc.message.IEService getIEService() {
    if (iEService == null)
      _initIEServiceProxy();
    return iEService;
  }
  ...
  public boolean createPartsSOAP(java.lang.String part_name, java.lang.String product_name) throws java.rmi.RemoteException{
    if (iEService == null)
      _initIEServiceProxy();
    return iEService.createPartsSOAP(part_name, product_name);
  }
